...
export default function RoomList({ rooms, onChange }: RoomListProps) {
    ...
    <div className="space-y-4">
      <div className="flex flex-col md:flex-row justify-between md:items-center mb-6 gap-4">
        <h3 className="text-xl font-semibold text-white flex items-center gap-2">
          <span className="w-8 h-8 rounded-lg bg-teal-400/20 flex items-center justify-center text-teal-400">
            1
          </span>
          Room Breakdown
        </h3>
        ...
        <div className="flex items-center gap-2">
          <select 
            ...
            className="bg-slate-900 border border-slate-700 text-slate-300 text-xs rounded-lg px-3 py-2 focus:ring-1 focus:ring-teal-400 focus:border-teal-400 outline-none"
          >
          ...
          <button 
            ...
            className="text-xs uppercase tracking-wider font-semibold text-teal-400 hover:text-teal-300 transition-colors whitespace-nowrap px-2"
          >
            + Custom
          </button>
        </div>
      ...
      <div className="grid gap-4">
        ...
        {rooms.map((room, idx) => (
          <div 
            key={room.id}
            className="group relative bg-slate-900/50 border border-slate-800 rounded-xl p-4 md:grid md:grid-cols-12 md:gap-4 md:items-center hover:bg-white/10 transition-all duration-300"
          ...
          >
            ...
            <div className="col-span-4 mb-3 md:mb-0">
              <input
                ...
                className="w-full bg-transparent border-none text-slate-200 font-medium focus:ring-0 focus:text-teal-400 placeholder-slate-600"
            ...
            <div className="col-span-3 flex items-center justify-center gap-3 mb-3 md:mb-0">
              <button 
                ...
                className="w-8 h-8 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:border-teal-400 transition-all"
              >
                <Minus size={14} />
              </button>
              ...
              <button 
                ...
                className="w-8 h-8 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-teal-400 hover:bg-teal-400 hover:text-slate-900 transition-all"
              >
                <Plus size={14} />
              </button>
            </div>
            ...
            <div className="col-span-3 flex items-center justify-center gap-2 mb-3 md:mb-0">
              <input
                ...
                className="w-16 bg-slate-900/50 border border-slate-700 rounded px-2 py-1 text-center text-slate-300 focus:border-teal-400 focus:outline-none"
              />
