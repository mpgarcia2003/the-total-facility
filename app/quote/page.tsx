  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 pt-24">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute -top-[200px] -right-[200px] w-[600px] h-[600px] bg-teal-500/5 rounded-full blur-3xl animate-pulse" />
      ...
      <div className="relative max-w-5xl mx-auto px-4 py-8 md:py-12">
        ...
        <header className="mb-16 md:mb-24 text-center space-y-6 pt-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-teal-400 mb-4">
            <Sparkles size={12} />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <button 
              ...
              className="px-8 py-4 bg-teal-400 hover:bg-teal-300 text-slate-950 font-bold rounded-xl transition-all shadow-[0_0_20px_rgba(45,212,191,0.3)] hover:shadow-[0_0_30px_rgba(45,212,191,0.5)] flex items-center justify-center gap-2"
            >
              Start Instant Quote →
            </button>
            <button 
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 backdrop-blur-xl">
              <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-2">
                <FaClipboardList className="text-teal-400" size={20} /> Project Details
              </h2>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-xs text-slate-500 uppercase">Client Name</label>
                  <div className="relative">
                    <FaUser className="absolute left-3 top-3 text-slate-600" size={16} />
                    <input 
                      type="text" 
                      placeholder="Enter Name"
                      value={clientInfo.name}
                      onChange={e => setClientInfo({...clientInfo, name: e.target.value})}
                      className="w-full bg-slate-900 border border-slate-700 rounded-lg py-2.5 pl-10 text-sm focus:border-teal-400 focus:outline-none text-white"
                    />
                  </div>
                </div>
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <FaMapMarkerAlt className="absolute left-3 top-3 text-slate-600" size={16} />
                    <input 
                      type="text" 
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <FaCalendar className="absolute left-3 top-3 text-slate-600" size={16} />
                    <input 
                      type="date" 
                      value={clientInfo.walkthroughDate}
                      onChange={e => setClientInfo({...clientInfo, walkthroughDate: e.target.value})}
                      className="w-full bg-slate-900 border border-slate-700 rounded-lg py-2.5 pl-10 text-sm focus:border-teal-400 focus:outline-none text-slate-300"
                    />
                  </div>
                </div>
                <div className="space-y-1">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-900 border border-slate-700 rounded-lg py-2.5 px-3 text-sm focus:border-teal-400 focus:outline-none text-teal-400 font-medium"
                  />
                </div>
              </div>
            </section>
            ...
            <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 backdrop-blur-xl">
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-slate-900 to-slate-800 rounded-xl border border-slate-700 flex justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-teal-400/10 rounded text-teal-400">
                    <FaClock size={20} />
                  </div>
                  <div>
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-teal-400 font-mono">{quote.totalDailyHours.toFixed(2)} hours</div>
                </div>
              </div>
            </section>
            ...
            <section className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 backdrop-blur-xl space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 <div className="space-y-1">
                  ...
                  <input 
                    ...
                    className="w-full md:w-1/2 bg-slate-900 border border-slate-700 rounded-lg py-2 px-3 text-white focus:border-teal-400 focus:outline-none"
                  />
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-2 space-y-2">
                    <label className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-all ${includeSummer ? 'bg-teal-400/10 border-teal-400 text-white' : 'bg-slate-900 border-slate-800 text-slate-400'}`}>
                      <div className="flex items-center gap-2">
                        <input 
                          type="checkbox" 
                          checked={includeSummer} 
                          onChange={e => setIncludeSummer(e.target.checked)}
                          className="w-4 h-4 rounded text-teal-400 focus:ring-teal-400 bg-slate-800 border-slate-600"
                        />
                    ...
                    <label className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-all ${includeWinter ? 'bg-teal-400/10 border-teal-400 text-white' : 'bg-slate-900 border-slate-800 text-slate-400'}`}>
                      <div className="flex items-center gap-2">
                        <input 
                          type="checkbox" 
      ...
      <div className="lg:hidden fixed bottom-0 left-0 w-full bg-slate-900/90 backdrop-blur-lg border-t border-slate-800 p-4 z-50">
        <div className="flex items-center justify-between gap-4">
          ...
          <button 
            ...
            className="bg-teal-400 text-slate-900 font-bold px-6 py-3 rounded-lg flex items-center gap-2"
          >
            Get Quote →
          </button>
        </div>
