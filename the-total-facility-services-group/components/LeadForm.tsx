...
const LeadForm: React.FC<LeadFormProps> = ({ quote, clientInfo, onSubmit, onSchedule }) => {
  ...
  if (submitted) {
    return (
      <div className="bg-gradient-to-br from-brand-accent/20 to-brand-dark border border-brand-accent/30 rounded-2xl p-10 text-center animate-float">
        <div className="w-20 h-20 bg-brand-accent rounded-full flex items-center justify-center mx-auto mb-6 shadow-[0_0_30px_rgba(45,212,191,0.4)]">
        ...
        <p className="text-slate-300 mb-6">
          Thank you, <span className="text-brand-accent">{formData.name}</span>. We have sent a copy of this estimate to 
          <span className="text-brand-accent"> {formData.email}</span>.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-slate-800/50 border border-slate-700 rounded-lg py-2.5 pl-10 pr-4 text-white focus:ring-2 focus:ring-brand-accent focus:border-transparent transition-all outline-none"
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              className="w-full bg-slate-800/50 border border-slate-700 rounded-lg py-2.5 px-4 text-white focus:ring-2 focus:ring-brand-accent focus:border-transparent transition-all outline-none"
          ...
          <div className="flex flex-col md:flex-row gap-4 pt-4">
            <button 
              type="submit"
              className="flex-1 bg-gradient-to-r from-brand-accent to-teal-500 text-slate-900 font-bold py-4 rounded-xl hover:shadow-[0_0_20px_rgba(45,212,191,0.5)] transition-all transform hover:-translate-y-1"
            >
